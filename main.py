...
class HexoToTypecho():
    ...
    def relationships(self):
        ...
        try:
            ...
            cid = cur.fetchall()[0][0]  # 鑾峰彇 cid

            if isinstance(data[2], list):
                for i in data[2]:
                    cur.execute(select_mid, (i, 'tag'))
                    tu = cur.fetchall()
                    # print('mid = ', tu[0][0])  # mid 鑾峰彇
                    mid = tu[0][0]
...
if __name__ == '__main__':
    ...
    print('鎬绘湁', files)
    HexoToTypecho(host='132.145.113.49', user='typecho', database='localhost', files='_posts', passwd='wo2ysywo2ysy')